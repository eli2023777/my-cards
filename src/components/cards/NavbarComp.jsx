...
const NavbarComp = ({ toggleDarkMode, isDark }) => {

    // Initial Log-in mode by localStorage and use it in the state as initial value
                                ...
                                >
                                    ...
                                    <Offcanvas.Body>
                                        ...
                                        <Nav className="justify-content-end flex-grow-1 pe-3">
                                            ...
                                            <Button variant="none" onClick={toggleDarkMode}
                                            >
                                                {!isDark ? (
